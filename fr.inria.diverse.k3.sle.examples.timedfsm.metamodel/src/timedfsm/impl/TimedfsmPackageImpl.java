...
public class TimedfsmPackageImpl extends EPackageImpl implements TimedfsmPackage {
	 ...
	 * @generated
	 */
	public EAttribute getState_WaitingTime() {
	 ...
	 * @generated
	 */
	public EAttribute getTransition_WaitingTime() {
	...
	public void createPackageContents() {
		...
		createEAttribute(stateEClass, STATE__WAITING_TIME);
		...
		createEAttribute(transitionEClass, TRANSITION__WAITING_TIME);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(fsmEClass, timedfsm.FSM.class, "FSM", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFSM_OwnedState(), this.getState(), this.getState_OwningFSM(), "ownedState", null, 0, -1, timedfsm.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_InitialState(), this.getState(), null, "initialState", null, 1, 1, timedfsm.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_FinalState(), this.getState(), null, "finalState", null, 1, -1, timedfsm.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getState_WaitingTime(), ecorePackage.getEInt(), "waitingTime", null, 0, 1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTransition_WaitingTime(), ecorePackage.getEInt(), "waitingTime", null, 0, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
