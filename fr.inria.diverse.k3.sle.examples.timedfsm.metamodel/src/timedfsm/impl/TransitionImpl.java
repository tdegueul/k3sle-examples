 ...
 *   <li>{@link timedfsm.impl.TransitionImpl#getWaitingTime <em>Waiting Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	public void setWaitingTime(int newWaitingTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimedfsmPackage.TRANSITION__WAITING_TIME, oldWaitingTime, waitingTime));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TimedfsmPackage.TRANSITION__OUTPUT:
				return getOutput();
			case TimedfsmPackage.TRANSITION__WAITING_TIME:
